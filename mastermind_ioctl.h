...
#define MMIND_REMAINING _IO(MASTERMIND_IOC_MAGIC,  13)
#define MMIND_NEWGAME _IO(MASTERMIND_IOC_MAGIC,  14)
#define MMIND_ENDGAME _IO(MASTERMIND_IOC_MAGIC,  15)
#define MASTERMIND_IOC_MAXNR 15
